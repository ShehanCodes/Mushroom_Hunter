...
playerLeft.src = 'man_flying_left.png'
const playerRight = new Image();
playerRight.src = 'man_flying_right.png'
...
class Bubble {
    ...
    draw(){
        ...
        ctx.drawImage(egg, this.x - this.radius, this.y - this.radius, this.radius * 2, this.radius * 2);
    }
}
